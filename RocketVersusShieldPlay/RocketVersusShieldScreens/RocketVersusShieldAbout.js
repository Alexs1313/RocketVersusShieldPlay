...
const RocketVersusShieldAbout = () => {
  ...
  const handleRocketVersusShieldShare = () => {
    Share.share({
      message: `Rocket Versus Shield Play is a competitive space arcade game where players take control of a rocket or a defensive shield in fast reflex-based matches. Play solo against AI or challenge friends in party mode, earn stars in every game, unlock visual skins, and climb the global leaderboard.`,
    });
  };
